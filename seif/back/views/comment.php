...
<tbody>
				...
				?>
					<div class="btn-group">
							...
							<a class="btn btn-primary btn-sm" href="modifierCommentaire.php?num='<?php echo $row['num']?>'" >Modifier</a>
      ...
      <li id="stat" ><a href="stat.php"><i class="fa fa-bars"></i><span>stat</span></a></li>
		        ...
		        <li><a href="#"><i class="fa fa-envelope"></i><span>Mailbox</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><i class="fa fa-cog"></i><span>System</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
			            ...
			            <li id="menu-academico-boletim" ><a href="comment.php">Ajouter promotion</a></li>
