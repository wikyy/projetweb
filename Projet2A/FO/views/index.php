   ...
   <body>
                           ...
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
                                    ...
                                    <p class="mt-3"><span class="fas fa-quote-left"></span> <span class="fas fa-quote-right"></span>
                                    </p>
                                 </div>
                              </div>
                           </div>
         ...
         <div class="row">
            ...
            <div class="col-lg-6 col-md-6 address-w3l-right text-center">
               <div class="address-gried ">
                  ...
                  <p>Rue Hedi Chaker,Lafayette<br>Tunis
                  <p>
               </div>
      ...
      <footer class="py-lg-4 py-md-3 py-sm-3 py-3 text-center">
         <div class="copy-agile-right">
            <p> 
               © 2019 Dr Parebrise. All Rights Reserved | Design by Pentagon
            </p>
         </div>
      </footer>
      <!-- //footer -->
                     ...
                     <form action="process.php" method="POST">
                        <div class="fields-grid">
                           <div class="styled-input">
                              <input type="text" placeholder="Your Name" id="User" name="User" required="">
                           </div>
                           <div class="styled-input">
