...
<html lang="zxx">
   <head>
      ...
      <!-- //font-awesome icons -->
      <!--Shoping cart-->
      <link rel="stylesheet" href="css1/shop.css" type="text/css" />
      <!--//Shoping cart-->
      <!--price range-->
            ...
            ?>
                     <div class="col-lg-4 col-md-6 col-sm-6 product-men women_two">
                        <div class="product-toys-info">
                           ...
                           <?php   echo   '<img src="images/'.$row['Photo'].'" class="img-thumbnail img-fluid" alt="">' ?>
                                 ...
                                 <div class="info-product-price">
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          <h4>
                                             <a href="single.html"><?php echo '<td>'.$row['Nom'].'</td>';?> </a>
                                          </h4>
                                          <div class="grid-price mt-2">
                                             <span class="money "><?php echo '<td>'.$row['Description'].'</td>';?></span>
                                          </div>
                                       </div>
                                    </div>

                                  <?php if ($row['Nbr_participantMax']>$row['Nbr_participant'] )
                                  {


                                   echo ' <a class="btn btn-primary btn-sm" href="reserverEvent.php?id='.$row['ID_event'].' "> reserver</a>  '; } ?>                   </div>
                                 <div class="clearfix"></div>
                              </div>
                           </div>
                        </div>
