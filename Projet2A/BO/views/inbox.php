							...
							<!--search-box-->
								<div class="search-box">
									<form>
										...
										<input type="submit" value="" href="C:/wamp64/www/Projet2A/FO/core/recherche.php">					
									</form>
								</div><!--//end-search-box-->
				            ...
				            <ul class="dropdown-menu float-right">
				                <li>
				                    <a href="#" title="">
				                       ...
				                       <input type="submit" value="Edit" href="inbox.php">
				                    </a>
				                </li>
				                <li>
				                    <a href="#" title="">
				                ...
				                <li>
				                    <a href="#" class="font-red" title="">
				                        ...
				                        <input type="submit" value="Delete" href="inbox.php" >
				                    </a>
				                </li>
								</form>
				            </ul>
...
$r=new reclamationss();
$listereclamation=$r->afficherreclamations();
$r->supprimerreclamations();
?>
