					...
					foreach ($liste as $row) {
						echo '<tr>';
							...
							echo '<td>'.$row['Date_fin'].'</td>';
								...
								$nouveauPrix = $promotionCore->calculerNouveauPrix($row['ID_produit']);

							echo '<td>'.$nouveauPrix.'</td>';
							echo '<td>';
				?>
					<div class="btn-group">
							...
							<a class="btn btn-primary btn-sm" href="modifierPromotion.php?Nom='<?php echo $row['Nom']?>'" >Modifier</a>
