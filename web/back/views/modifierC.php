            ...
            <div class="contact-list-grid">
             ...
             <form method="POST" >
                  <div class=" agile-wls-contact-mid">
                     ...
                     <button type="submit" name="modifier" class="btn btn-block sent-butnn" onclick="afficher()" >Send</button>
                  </div>
              </form>
            </div>
                    <?php
...
if (isset($_POST['modifier'])){
	$credit=new credit($_POST['nom'],$_POST['marque'],$_POST['montant']);
	$e->modifiercredit($credit,$_POST['nom']);
	//echo $_POST['nom'];
