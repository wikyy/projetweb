            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.html">Dr Pare Brise</a></h1>
                  </div>
               ...
               <ul class="navbar-nav ">
                 ...
                 <li class="nav-item dropdown">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="product.html">Pare Brise</a>
                        <a class="nav-link " href="product.html">Pare Brise</a>
                        <a class="nav-link " href="product.html">Pare Brise </a>
                        <a class="nav-link " href="product.html">Pare Brise</a>
                     </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <form method="POST" action="traitement2.php">
                        ...
                        <input type="hidden" value= "seif" name="user" id="user" >
...
?></td>
                     ...
                     <form method="POST" action="traitement2.php">
                       ...
                       <td> <button class="btn"><i class="fa fa-thumbs-down"></i></button></td>
                        ...
                        <input type="hidden" value= "2" name="react" id="react" >
                        <input type="hidden" value= "seif" name="user" id="user" >
                     ...
                     <td>
                      <?php
$db=config::getconnexion();
$req="SELECT  SUM(react)  FROM reaction WHERE react=2";
$list=$db->query($req);
foreach ($list as $row)
 $s=($row[0])/2;
echo '('.$s.')';
?>
                     ...
                     <div class="occasional">
                        <h5>Types :</h5>
                        <div class="colr ert">
                           <label class="radio"><input type="radio" name="radio" checked=""><i></i> Pare Brise</label>
                        </div>
                        <div class="colr">
                           <label class="radio"><input type="radio" name="radio"><i></i>Pare Brise</label>
                        </div>
                        <div class="colr">
                           <label class="radio"><input type="radio" name="radio"><i></i>Pare Brise</label>
                        </div>
                                       ...
                                       <form method="POST" action="traitement.php">
                                          <div class="row">
                                             <div class="col-md-6">
                                                ...
                                                <td><span id="missnom"></span></td>
                                             </div>
                                             <div class="col-md-6">
                                                <input type="email" name="address" id="address" >
                                                <td><span id="missaddress"></span></td>
                                             </div>
                                          </div>
    ...
    var formValid = document.getElementById('bouton');
            ...
            function validation(event){
                ...
                if (address.validity.valueMissing){
                    event.preventDefault();
                    missaddress.textContent = 'address manquant';
            ...
            var missmsg = document.getElementById('missmsg');
            var msgValid = /[A-Z-a-z]/;
            ...
            function validation(event){
                ...
                if (msg.validity.valueMissing){
                    event.preventDefault();
                    missmsg.textContent = 'msg manquant';
                    missmsg.style.color = 'red';
      
               
                //Si le format de données est incorrect
                }else if (msgValid.test(msg.value) == false){
                    event.preventDefault();
                    missmsg.textContent = 'Format incorrect';
                    missmsg.style.color = 'orange';
                }
            }
</script>
      <!-- start-smoth-scrolling -->
