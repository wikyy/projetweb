            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.html">Shop</a></h1>
                  </div>
...
{
   $listelignes=$db->query("SELECT * FROM ligne ORDER BY `id_commande` ASC");
}
else if(isset($_POST['tria']))
{
   $listelignes=$db->query("SELECT * FROM ligne ORDER BY ligne.`id_commande` DESC");
}
else 

$listelignes=$r->afficherlignes();
...
<form method="POST">
                  <button width="50%" type="submit" class="col-md-4 checkout-left-basket" name="tri" >tri croissant</button> 
                  <button width="50%" type="submit"class="col-md-4 checkout-left-basket" name="tria" >tri decroissant</button> 
                 </form>
                     ...
                     <div class="checkout-left">
                        <div class="col-md-4 checkout-left-basket">
                           <h4><a href=mail.php>Continue to basket </a></h4>
...
?>
                        ...
                        <div class="col-md-8 address_form">
                                 ...
                                 <div class="information-wrapper">
                                    <div class="first-row form-group">
                                       <div class="controls">
                                          ...
                                          <input class="billing-address-name form-control" id=nom type="text" name="mail" placeholder=" mail">
                                       </div>
                                       <div class="card_number_grids">
                                          <div class="card_number_grid_left">
                                             <div class="controls">
                                                <label class="control-label"> password:</label>
                                                <input class="form-control" id="phone" type="password" placeholder=" password">
                                             </div>
                                          </div>
                                    ...
                                    <button class="submit check_out"  onclick="afficher()">connect if want to buy</button>
                                 </div>
                              </section>
                           </form>
                           <div class="checkout-right-basket">
                              ...
                              <a href="supprimerpanieu.php">confirmer votre commande </a>
