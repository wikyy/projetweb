...
function ajouterpanier($panier){
      $sql="insert into panier(id_commande,id_client) values (:id_commande, :id_client)";
...
function modifierpanier($panier,$id_commande){
    $sql="UPDATE panier SET  id_commande=:id_commande,id_client=:id_client where id_commande=:id_commande";
