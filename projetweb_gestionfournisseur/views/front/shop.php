         ...
         <div class="container-fluid">
            <div class="hedder-up row">
               <div class="col-lg-3 col-md-3 logo-head">
                  <h1><a class="navbar-brand" href="index1.php">Toys-Shop</a></h1>
               </div>
                  ...
                  <div class="cart-icons">
                     <ul>
                        ...
                        <li class="toyscart toyscart2 cart cart box_1">
                           <form  method="POST" action="afficherligne.php">
         ...
         <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item">
                     <a href="afficherligne.php" class="nav-link">Service</a>
                  </li>
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form ac method="POST" action="ajouterligne">
                                          <input type="hidden" name="id_commande" value="4">
                                          <input type="hidden" name="id_produit" value=1>
                                          <input type="hidden" name="prix" value="120">
                                          <input type="hidden" name="quantite" value="1">
                                        <a href="chechout.php">  <button type="submit" class="toys-cart ptoys-cart">
                                 ...
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          <input type="hidden" name="id_commande" value="1">
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="id_produit" value="12">
                                          <input type="hidden" name="prix" value="48000">
                           ...
                           <div class="men-pro-item">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          <input type="hidden" name="id_produit" value="9">
                                          <input type="hidden" name="id_commande" value="8">
                                          <input type="hidden" name="quantite" value="1 ">
                                          <input type="hidden" name="prix" value="67">
                                          <button type="submit" class="toys-cart ptoys-cart">
                                          <i class="fas fa-cart-plus"></i>
                                          </button>
                                       </form>
                           ...
                           <div class="men-pro-item">
                              ...
                              <div class="item-info-product">
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          <input type="hidden" name="f" value="_cart">
                                          <input type="hidden" name="id_produit" value="10">
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="prix" value="340">
                                          <button type="submit" class="toys-cart ptoys-cart">
                                          <i class="fas fa-cart-plus"></i>
                                          </button>
                                       </form>
                                 ...
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          ...
                                          <input type="hidden" name="id_produit" value="9">
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="prix" value="160">
                                          <button type="submit" class="toys-cart ptoys-cart">
                                          <i class="fas fa-cart-plus"></i>
                                          </button>
                                       </form>
                                 ...
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          ...
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="prix" value="480">
                                          <button type="submit" class="toys-cart ptoys-cart">
                                          <i class="fas fa-cart-plus"></i>
                                          </button>
                                       </form>
                                 ...
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          ...
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="prix" value="265">
                                          <button type="submit" class="toys-cart ptoys-cart">
                                          <i class="fas fa-cart-plus"></i>
                                          </button>
                                       </form>
                                 ...
                                 <div class="info-product-price">
                                    ...
                                    <div class="toys single-item hvr-outline-out">
                                       <form action="ajouterligne.php" method="post">
                                          <input type="hidden" name="cmd" value="_cart">
                                          <input type="hidden" name="quantite" value="1">
                                          <input type="hidden" name="id_produit" value="7">
...
<form action="logout.php" method="post">
                        <div>
                           <button type="submit" class="btn subscrib-btnn">Logout</button>
                        </div>
                         </form>
                         <?php
}
