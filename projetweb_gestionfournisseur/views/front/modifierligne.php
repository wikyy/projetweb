...
if (isset($_GET['id_produit'])){
   $lignec=new lignec();   
    $result=$lignec->recupererligne1($_GET['id_produit'],$a);
...
<tr>
<td>quantité</td>
<td><input type="number" min="1" name="quantite" value="<?PHP echo $quantite ?>"></td>
</tr>
...
if (isset($_POST['modifier'])){
   ...
   $lignec->modifierligne($ligne,$_POST['id_produit_ini'],$a);
   echo $_POST['id_produit_ini'];
  // header('Location: afficherligne.php');
   echo " est l id du produit ,l nouvelle quantite est".$_POST['quantite'];

?>
<br>
 <a href="afficherligne.php">votre changement a bien etez effectuer :afficher la commande</a>
<?php  
}
