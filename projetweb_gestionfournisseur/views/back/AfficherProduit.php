					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form>
<input type="text" id="myInput" onkeyup="myFunction()" title="type in a name" class="form-control bg-transparent border-0" placeholder="Search ">										<input type="submit" value="">					
									</form>
								</div><!--//end-search-box-->
