...
<div class="inner-block">
    <div class="product-block">
    	<div class="pro-head">
    	 ...
    	 <form method="POST" action="ajoutF.php" class="com-mail" enctype="multipart/form-data">
<table class="table">
<tr>
<td>Nom Fournisseur</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="nom_fournisseur" name="nom_fournisseur" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
...
<td><input type="text" name="numtel" required></td>
</tr>
<tr>
